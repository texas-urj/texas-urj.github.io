...
const PioneerHome = () => {
  return (
    <>
      ...
      </div><div className='flex justify-center mx-4'>
      ...
      </div><div className='flex justify-center mx-4'><ArticleCard route = "/pioneer/think-smaller"
      thumbnail='https://i.imgur.com/5CIC3VD.png'
      title="Let's Think Smaller"></ArticleCard>
      </div><div className='flex justify-center mx-4'><ArticleCard route = "/pioneer/perfect-pasta"
      thumbnail='https://i.imgur.com/ZyvwsrJ.png'
      title='The Science of Perfect Pasta'></ArticleCard>
      </div><div className='flex justify-center mx-4'><ArticleCard route = "/pioneer/reading-dead"
