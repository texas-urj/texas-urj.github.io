...
const EventsHome = () => {
  return (
    <>
      ...
      <ArticleCard thumbnail='https://i.imgur.com/TgaKoS7.jpg' title='Networking Night' route='/events/networkingnight'></ArticleCard>
      <ArticleCard thumbnail='https://i.imgur.com/zYNtu0b.jpg' title='Pen to Publication' route='/events/ptp'></ArticleCard></section>
    </>
  );
};
