  ...
  return (
    <>
      ...
      <AccordionContent><div className='flex flex-col items-center mb-4'>
        ...
        headshot="" bio="Sneha is a third-year Biology major who is also perusing the Scientific Computation and Data Science certificate. She is also a writer with HerCampus and involved in the FRI lab Microbe Hackers and the Havird lab. In her free time, she enjoys baking, crocheting, and other habits a grandmother may enjoy."> </TeamCard>
