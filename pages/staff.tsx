  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center mb-4'>
        ...
        headshot="https://i.imgur.com/v5xhlIt.jpg" bio="Meghna is a third-year Biology major interested in going into research as a career-either academic or industrial. In her free time, she enjoys listening to music, playing games, and taking walks around the UT campus. Contact her at meghnavergis@utexas.edu"> </TeamCard>
